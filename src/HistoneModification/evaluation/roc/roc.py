...
if __name__ == '__main__':
    # Useage: python /local/zzx/code/BioSeq2Seq/src/HistoneModification/evaluation/roc/roc.py --exper /local/zzx/code/BioSeq2Seq/test_samples/H3k4me1.bed --pre /local/zzx/code/BioSeq2Seq/test_samples/H3k4me1.pred.bw -o /local/zzx/code/BioSeq2Seq/test_samples
