...
import pysam
from genome_tools import CovFace
...
def get_double_stranded_input_feature(samples, sequencing_data_files, extend=40960, nan=None, model_type='HistoneModification'):
    """ 
    ...
    for sample in samples:
        ...
        if model_type == 'FunctionalElement':
...
def get_input_seq_feature(samples, sequencing_data_files, extend=40960, nan=None, model_type='HistoneModification'):
    """ 
    get ground truth of samples
    ...
    if len(sequencing_data_files) == 2:
        return get_double_stranded_input_feature(samples, sequencing_data_files, extend=extend, nan=nan, model_type=model_type)
