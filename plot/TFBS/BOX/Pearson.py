...
width_mm = 242.5 # width in mm
height_mm = 35.96 # height in mm
...
prc_order_list = ['SMAD5', 'MYC', 'TBP', 'NEUROD1', 'MAZ', 'MAX', 'ELF4', 'CTCF', 'ETS1', 'SP1', 'ATF1', 'ELF1', 'CREM', 'NKRF', 'SPI1', 'SKIL', 'NRF1', 'FOSL1', 'MXI1', 'ATF3', 'IKZF1', 'ZBED1', 'TEAD4', 'MBD2', 'SOX6', 'CREB1', 'MNT', 'ZBTB7A', 'ELK1', 'BHLHE40', 'SMAD1', 'GATAD2B', 'E2F8', 'NFATC3', 'NR2C1', 'NR2F1', 'RUNX1', 'PKNOX1', 'NR2F2', 'TCF7', 'EGR1', 'MAFF', 'MYBL2', 'ATF2', 'STAT5A', 'RFX1', 'ZBTB11', 'NFIC', 'ESRRA', 'LEF1', 'ZNF592', 'NR2F6', 'ETV6', 'JUND', 'E4F1', 'ZBTB40', 'ARNT', 'SIX5', 'USF2', 'POU5F1', 'ASH1L', 'ZNF384', 'FOXK2', 'ZNF24', 'MAFK', 'CEBPB', 'MEF2A', 'BACH1', 'SETDB1', 'FOXM1', 'ZNF282', 'ZSCAN29', 'SREBF1', 'ZZZ3', 'CEBPZ', 'RFX5', 'JUNB', 'TCF12', 'CUX1', 'HES1', 'TCF7L2', 'REST', 'ZNF47', 'JUN', 'ZNF274', 'ZBTB33', 'ZKSCAN1', 'ATF7', 'NFXL1', 'FOXA1']
...
tf_index = []
for tf in prc_order_list:
    index = tf_list.index(tf)
    tf_index.append(index)


tf_list = np.asarray(tf_list)
prc_list = np.asarray(prc_list)

tf_list = tf_list[tf_index]
prc_list = prc_list[tf_index]
...
axes.set_xticklabels(tf_list, rotation=90, fontproperties=arial_font, fontsize=7)  # 设置x轴刻度标签为tf_list，并旋转90度
axes.set_yticklabels(axes.get_yticks(), fontproperties=arial_font, fontsize=7)
...
# 或者用FormatStrFormatter来指定显示格式，例如显示2位小数：
