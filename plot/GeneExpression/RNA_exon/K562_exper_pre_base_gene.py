...
# 文件路径
file_pre_exon = r'F:\result\RNA\exon_gene\K562\exon_stat\aggregated_predicted_exon.bed'
file_exper_exon = r'F:\result\RNA\exon_gene\K562\exon_stat\aggregated_experimental_exon.bed'
file_pre_gene = r'F:\result\RNA\exon_gene\K562\exon_stat\predicted_gene.bed'
file_exper_gene = r'F:\result\RNA\exon_gene\K562\exon_stat\experimental_gene.bed'
