...
mean_dHIT2 = mean_dHIT2 / 5
mean_dHIT = mean_dHIT / 5
...
plt.xlabel('dHIT Pearson Correlation')
plt.ylabel('BioSeq2Seq (RD) Pearson Correlation')
# plt.title(cellline, fontdict={'family': 'Arial', 'size': 15})
