...
model_128_seq = excel_data(data_path, 30, 5, cell_line)
print(model_128_seq)
model_128_ro = excel_data(data_path, 4, 5, cell_line)
print(model_128_ro)
model_128_rd = excel_data(data_path, 17, 5, cell_line)
print(model_128_rd)
...
plt.ylabel("Spearman correlation (CD4$^{+}$  T cells)")
