...
histone_modi = ('H3K122ac', 'H3K4me1', 'H3K4me2', 'H3K4me3', 'H3K27ac', 'H3K27me3', 'H3K36me3', 'H3K9ac', 'H3K9me3', 'H4K20me1')
...
row_id = 57
col_id = 1
model_128_seq = excel_data(data_path, 285, 5, cell_line)
model_128_ro = excel_data(data_path, 259, 5, cell_line)
model_128_rd = excel_data(data_path, 272, 5, cell_line)
...
plt.ylabel("Spearman correlation (K562)")
plt.xticks(index, histone_modi, rotation=45, ha='right')
plt.legend((p1[0], p2[0], p3[0]), ('BioSeq2Seq D (1k bp)', 'BioSeq2Seq R (1k bp)', 'BioSeq2Seq RD (1k bp)'),
           ncol=5,
           bbox_to_anchor = (0.95, 1.15), frameon=False)
