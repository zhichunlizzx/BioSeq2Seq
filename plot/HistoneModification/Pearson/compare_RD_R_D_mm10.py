...
model_128_seq = excel_data(data_path, 28, 2, cell_line)
model_128_ro = excel_data(data_path, 2, 2, cell_line)
model_128_rd = excel_data(data_path, 15, 2, cell_line)
...
plt.ylabel("Pearson correlation (Liver (Mouse))")
