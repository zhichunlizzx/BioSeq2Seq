...
row_id = 57
col_id = 1
model_128_seq = excel_data(data_path, 285, 2, cell_line)
model_128_ro = excel_data(data_path, 259, 2, cell_line)
model_128_rd = excel_data(data_path, 272, 2, cell_line)
...
plt.ylabel("Pearson correlation (K562)")
