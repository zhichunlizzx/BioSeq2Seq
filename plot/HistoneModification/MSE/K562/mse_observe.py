...
col_id = 1
rd = excel_data(data_path, lines, 17, cell_line)
print(rd)
# dhit = excel_data(data_path, lines, 18, cell_line)
r = excel_data(data_path, lines, 19, cell_line)
d = excel_data(data_path, lines, 20, cell_line)
