...
col_id = 1
rd = excel_data(data_path, lines, 9, cell_line)
print(rd)
# dhit = excel_data(data_path, lines, 10, cell_line)
r = excel_data(data_path, lines, 11, cell_line)
d = excel_data(data_path, lines, 12, cell_line)
