...
col_id = 1
rd = excel_data(data_path, lines, 13, cell_line)
print(rd)
# dhit = excel_data(data_path, lines, 14, cell_line)
r = excel_data(data_path, lines, 15, cell_line)
d = excel_data(data_path, lines, 16, cell_line)
...
# plt.legend((p1[0], p2[0], p3[0], p4[0]), ('dHIT (1k bp)', 'R (1k bp)', 'D (1k bp)', 'RD (1k bp)'),
#            ncol=5,
#            bbox_to_anchor = (1.0, 1.1), frameon=False)
plt.show()