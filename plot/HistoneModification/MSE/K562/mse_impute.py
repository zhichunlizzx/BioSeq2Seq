...
col_id = 1
rd = excel_data(data_path, lines, 21, cell_line)
print(rd)
# dhit = excel_data(data_path, lines, 22, cell_line)
r = excel_data(data_path, lines, 23, cell_line)
d = excel_data(data_path, lines, 24, cell_line)
